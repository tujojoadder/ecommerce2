                ...
                for (let n = 0; n < this.countries.length; n++) {
                    ...
                    this.options.localizedCountries.hasOwnProperty(i) &&
                        (this.countries[n].name =
                            this.options.localizedCountries[i]);
                }
            },
                            ...
                            n.which == r || n.which == u
                                ...
                                : n.which == l
                                    ...
                                    : n.which == h
                                        ...
                                        : (n.which >= p && n.which <= y) ||
                                            n.which === d
                                            ? ((i.typedLetters += String.fromCharCode(
                                                n.which
                                            )),
                                                i._filterCountries(i.typedLetters))
                                            : n.which === c &&
                                            ((i.typedLetters = i.typedLetters.slice(
                                                0,
                                                -1
                                            )),
                                                i._filterCountries(i.typedLetters));
            ...
            _filterCountries: function (i) {
                ...
                if (t.length) {
                    ...
                    (e =
                        a &&
                            a.next() &&
                            0 === a.next().text().toUpperCase().indexOf(i)
                            ? a.next()
                            : t.first()),
                ...
                if (t) {
                    ...
                    if (t.length <= 2)
                        for (var s = 0; s < this.countries.length; s++)
                            this.countries[s].iso2.match(a) &&
                                e.push(this.countries[s].iso2);
                    if (0 == e.length)
                        for (s = 0; s < this.countries.length; s++)
                            this.countries[s].name.match(a) &&
                                e.push(this.countries[s].iso2);
                    var o = !1;
                    return (
