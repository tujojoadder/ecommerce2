!(function (t, e) {
    ...
    function o(o) {
        ...
        return (
            e(o)
                ? ((i = r(o)), Array.isArray(o) && (i += "[" + o.length + "]"))
                : (i = n(t(o), o, o)),
            i
        );
    }
    ...
    function s(t, e, r) {
        ...
        return (
            ...
            void 0 !== r &&
                (r instanceof Node
                    ? n.appendChild(r)
                    : n.appendChild(document.createTextNode(String(r)))),
            n
        );
    }
    !(function (t) {
            ...
            void 0 === e && (e = 1),
                ...
                void 0 === this.config.hoverPreviewArrayCount &&
                    (this.config.hoverPreviewArrayCount =
                        d.hoverPreviewArrayCount),
                void 0 === this.config.hoverPreviewFieldCount &&
                    (this.config.hoverPreviewFieldCount =
                        d.hoverPreviewFieldCount),
                void 0 === this.config.useToJSON &&
                    (this.config.useToJSON = d.useToJSON),
                "" === this.key && (this.key = '""');
        }
        return (
            ...
            Object.defineProperty(c.prototype, "useToJSON", {
                get: function () {
                    return (
                        this.config.useToJSON && "stringifiable" === this.type
                    );
                },
                enumerable: !0,
                configurable: !0,
            ...
            (c.prototype.getInlinepreview = function () {
                ...
                var e = this.keys,
                    ...
                    n =
                        e.length >= this.config.hoverPreviewFieldCount
                            ? "…"
                            : "";
                return "{" + r.join(", ") + n + "}";
            }),
            (c.prototype.render = function () {
                ...
                if (
                    (this.isObject &&
                        !this.useToJSON &&
                        t.appendChild(s("span", "toggler")),
                    this.hasKey &&
                        t.appendChild(s("span", "key", this.key + ":")),
                    ...
                    if ((r.appendChild(o), this.isArray)) {
                        ...
                        a.appendChild(s("span", "bracket", "[")),
                            a.appendChild(
                                s("span", "number", this.json.length)
                            ),
                            a.appendChild(s("span", "bracket", "]")),
                            r.appendChild(a);
                    }
                    ...
                    (e = this.isUrl ? s("a") : s("span")).classList.add(
                        i(this.type)
                    ),
                        this.isDate && e.classList.add(i("date")),
                        this.isUrl &&
                            (e.classList.add(i("url")),
                            e.setAttribute("href", this.json));
                    var f = n(
                        this.type,
                        this.json,
                ...
                return (
                    ...
                    this.config &&
                        this.config.theme &&
                        this.element.classList.add(i(this.config.theme)),
