...
class SupplierGroupDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($row) {
                $editbtn = Gate::any(['access-all', 'supplier-group-edit']) ? '<a href="javascript:;" id="incomeCategoryEditBtn" onclick="edit(' . $row->id . ')"  class="btn btn-sm mx-1 btn-info" ><i class="fas fa-pen-nib"></i></a>' : '';
     ...
     */
    public function query(SupplierGroup $model): QueryBuilder
    {
    ...
    {
        return 'SupplierGroup_' . date('YmdHis');
    }
}
