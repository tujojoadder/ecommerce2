...
class ChartOfAccountSubcategoryDataTable extends DataTable
{
    use RowIndex;
    /**
     ...
     */
    public function query(ChartOfAccountSubcategory $model): QueryBuilder
    {
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('subcategory_name')->addClass('text-center')->title(__('messages.subcategory').' '.__('messages.name')),
            Column::make('group_id')->addClass('text-center')->title(__('messages.group')),
            Column::make('chart_of_account')->addClass('text-center')->title(__('messages.chart_of_account')),
