...
class ReceiveSubcategoryDataTable extends DataTable
{
    use RowIndex;
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($row) {
                $editbtn = Gate::any(['access-all', 'receive-category-edit']) ? '<a href="javascript:;"  onclick="edit(' . $row->id . ')"  class="btn btn-sm mx-1 btn-info" ><i class="fas fa-pen-nib"></i></a>' : '';
                $deletebtn = Gate::any(['access-all', 'receive-category-delete']) ? '<a href="javascript:;" class="btn btn-sm mx-1 btn-danger" onclick="destroy(' . $row->id . ')"><i class="fas fa-trash"></i></a>' : '';
                $dropdown = '
     ...
     */
    public function query(ReceiveSubcategory $model): QueryBuilder
    {
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('subcategory_name')->addClass('text-center')->title(__('messages.name')),
