...
class ExpenseSubcategoryDataTable extends DataTable
{
    use RowIndex;
    /**
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('subcategory_name')->addClass('text-center')->title(__('messages.subcategory')),
    ...
    {
        return 'ExpenseSubcategory_' . date('YmdHis');
    }
}
