...
<div class="collapse collapse-vertical {{ $queryString == 'create' ? 'show' : '' }}" id="assetCollapse">
    <div class="card">
        <div class="card-header">
            <h6 class="modal-title" id="addText">{{ __('messages.asset') }} {{ __('messages.add') }}</h6>
            <h6 class="modal-title d-none" id="updateText">{{ __('messages.update') }} {{ __('messages.asset') }}</h6>
        </div>
        <div class="card-body">
            <div class="row" id="asset-form">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="input-group" data-bs-toggle="tooltip-primary" title="{{ __('messages.type') }}">
                            <select name="asset_type"class="form-control select2" id="asset_type">
                                <option value="" selected>{{ __('messages.select') }} {{ __('messages.type') }}</option>
                                <option value="deposit"> {{ __('messages.deposit') }}</option>
                                <option value="Purchase"> {{ __('messages.purchase') }}</option>
                            </select>
                        </div>
                    </div>
                    <span class="text-danger small" id="asset_type_Error"></span>
                </div>
                <div class="form-group col-xl-6 col-lg-6 col-md-6">
                ...
                <div class="form-group col-xl-6 col-lg-6 col-md-6">
                    <div class="input-group" data-bs-toggle="tooltip-primary" title="{{ __('messages.unit') }}">
                        <span class="input-group-text" title="unit" id="basic-addon1"><i class="fas fa-bars" title="unit"></i></span>
                        <input type="text" class="form-control" name="unit" placeholder="{{ __('messages.unit') }}" id="unit">
                    </div>
                    <span class="text-danger small" id="unit_Error"></span>
                </div>
                <div class="form-group col-xl-6 col-lg-6 col-md-6">
                    <div class="input-group" data-bs-toggle="tooltip-primary" title="{{ __('messages.quantity') }}">
                        <span class="input-group-text" title="quantity" id="basic-addon1"><i class="fas fa-bars" title="quantity No"></i></span>
                ...
                <div class="form-group col-xl-6 col-lg-6 col-md-6">
                    <div class="input-group" data-bs-toggle="tooltip-primary" title="{{ __('messages.price') }}">
                        <span class="input-group-text" title="rate" id="basic-addon1"><i class="fas fa-balance-scale" title="rate"></i></span>
                ...
                <div class="form-group col-xl-6 col-lg-6 col-md-6">
                    <div class="input-group" data-bs-toggle="tooltip-primary" title="{{ __('messages.amount') }}">
                        ...
                        <input type="text" readonly class="form-control" name="amount" placeholder="{{ __('messages.amount') }} " id="total_amount">
                    </div>
                ...
                <div class="form-group col-xl-6 col-lg-6 col-md-6">
                    <div class="d-flex">
                        <span class="input-group-text" title="bank" id="basic-addon1"><i class="fas fa-university" title="bank"></i></span>
                        <div class="input-group" data-bs-toggle="tooltip-primary" title="{{ __('messages.account') }}">
                            <select name="account_id" class="form-control select2" id="account">

                            </select>
                        </div>
                        <a id="accountAddModalBtn" class="add-to-cart btn btn-success" type="button" href="javascript:;"><i class="fas fa-plus"></i></a>
                    </div>
                    <span class="text-danger small" id="account_Error"></span>
                </div>
                <div class="form-group col-xl-6 col-lg-6 col-md-6">
                    <div class="d-flex">
                        <span class="input-group-text" title="Category" id="basic-addon1"><i class="fas fa-th-list"></i></span>
                        <div class="input-group" data-bs-toggle="tooltip-primary" title="{{ __('messages.category') }}">
                            <select name="category" class="form-control select2" id="category">
                                <option value="" selected>{{ __('messages.select') }} {{ __('messages.category') }}</option>
                ...
                <div class="form-group col-xl-6 col-lg-6 col-md-6">
                    <div class="d-flex">
                        <span class="input-group-text" title="c_account_group" id="basic-addon1"><i class="fas fa-th-list" title="c_account_group"></i></span>
                        <div class="input-group" data-bs-toggle="tooltip-primary" title="{{ __('messages.chart_of_account') }}">
                            <select class="form-control select2" name="chart_of_account" id="chart_of_account_id">

                            </select>
                        </div>
                        <a id="chartOfAccountModalBtn" class="add-to-cart btn btn-success" type="button" href="javascript:;"><i class="fas fa-plus"></i></a>
                    </div>
                    <span class="text-danger small" id="chart_of_account_id_Error"></span>
                </div>
                <div class="form-group col-xl-6 col-lg-6 col-md-6">
                    <div class="d-flex">
                        <span class="input-group-text" title="c_account_group" id="basic-addon1"><i class="fas fa-th-list" title="c_account_group"></i></span>
                        <div class="input-group" data-bs-toggle="tooltip-primary" title="{{ __('messages.chart_of_account_group') }}">
                            <select class="form-control select2" name="chart_account_group" id="chart_of_account_group_id">

                            </select>
                        </div>
                        <a id="chartOfAccountGroupBtn" class="add-to-cart btn btn-success" type="button" href="javascript:;"><i class="fas fa-plus"></i></a>
                    </div>
                    <span class="text-danger small" id="chart_of_account_group_id_Error"></span>
                </div>
                <div class="form-group col-xl-6 col-lg-6 col-md-6">
                    <div class="input-group" data-bs-toggle="tooltip-primary" title="Voucher No">
                ...
                <div class="form-group col-xl-6 col-lg-6 col-md-6">
                    <div class="input-group" data-bs-toggle="tooltip-primary" title="{{ __('messages.description') }}">
                        ...
                        <textarea name="description" class="form-control" id="description" cols="5" rows="1" placeholder="Description"></textarea>
                    </div>
            ...
            <div class="card-footer d-flex justify-content-between px-0">
                <button class="btn btn-danger" data-bs-toggle="collapse" data-bs-target="#assetCollapse" aria-expanded="false" aria-controls="assetCollapse" type="button"><i class="fas fa-ban"></i> {{ __('messages.cancel') }}</button>
...
@push('scripts')
    ...
    <script>
        ...
        //     }
        //     $('#quantity,#rate').on('input',updateTotalAmount);
        // })
        ...
        //ChartOfAccountGroup Information
        function fetchChartOfAccountGroups() {
            $.ajax({
                url: "{{ route('get.chart_of_account_groups') }}",
                dataType: 'json',
                success: function(data) {
                    var html = '';
                    $.each(data, function(index, value) {
                    ...
                    $('#chart_of_account_group_id').html(html);
        ...
        function clearAssetField() {
            ...
            $('#chart_of_account_group_id').val('');
            $('#chart_account_group_Error').text('');
            $('#chart_of_account_group_id').removeClass('border-danger');

            $('#voucher_no').val('');
            $('#voucher_no_Error').text('');
            $('#voucher_no').removeClass('border-danger');
        ...
        function addAsset() {
            ...
            var chart_of_account_id = $('#chart_of_account_id').val();
            var chart_of_account_group_id = $('#chart_of_account_group_id').val();
            ...
            $.ajax({
                ...
                data: {
                    ...
                    chart_of_account_group_id: chart_of_account_group_id,
                ...
                error: function(error) {
                    ...
                    if ($errors.account) {
                        $('#account_Error').text($errors.account);
                        $('#account').addClass('border-danger');
                        toastr.error($errors.account);
                    }

                    if ($errors.category) {
                        $('#category_Error').text($errors.category);
                        $('#category').addClass('border-danger');
                        toastr.error($errors.category);
                    }

                    if ($errors.chart_of_account_id) {
                        $('#chart_of_account_id_Error').text($errors.chart_of_account_id);
                        $('#namchart_of_account_ide').addClass('border-danger');
                        toastr.error($errors.chart_of_account_id);
                    }

                    if ($errors.chart_of_account_group_id) {
                        $('#chart_of_account_group_id_Error').text($errors.chart_of_account_group_id);
                        $('#chart_of_account_group_id').addClass('border-danger');
                        toastr.error($errors.chart_of_account_group_id);
                    }
        ...
        function edit(id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#chart_of_account_group_id').val(data.chart_of_account_group_id).trigger('change');
