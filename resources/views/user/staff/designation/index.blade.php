            ...
            <div class="card-header">
                <div class="text-end">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a data-bs-toggle="modal" id="designationBtn" data-bs-target="#staffDesignationModal" href="javascript:;" class="btn btn-success"><i class="fas fa-plus"></i> {{ __('messages.designation') }}</a>
                    </div>
                </div>
            </div>
...
@push('scripts')
    ...
    <script>
        function destroy(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var data_id = id;
                    var url = '{{ route('user.designation.destroy', ':id') }}';
        ...
        $("#designationtBtn").on('click', function() {
