    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('user.staff.assing.permission.store', $staff->id) }}" method="POST">
                        @csrf
                            ...
                            @foreach ($permissions as $key => $permission)
                                ...
                                <div class="col-md-2 px-1">
                                    <label class="form-control mb-0">
                                        <input type="checkbox" name="permissions[]" value="{{ $permission['name'] }}" {{ $staff->hasPermissionTo($permission['name']) ? 'checked' : '' }}>
                                        @php
