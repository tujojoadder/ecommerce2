                                ...
                                <table class="table table-bordered text-dark">
                                    <thead>
                                        <tr>
                                            ...
                                            <th colspan="6" style="border: 1px solid black !important;">
                                    ...
                                    <tbody>
                                        ...
                                        @endforeach
                                        <tr>
                                            <td style="border: 0px !important; vertical-align: baseline !important; padding-top: 10px !important;" colspan="4" rowspan="10">
                                            ...
                                            <td style="border: 1px solid black !important; font-size: 16px !important;  font-weight: bolder;" class="text-center">{{ __('messages.total') }} {{ __('messages.quantity') }}</td>
                                            <td style="border: 1px solid black !important; font-size: 16px !important; " class="text-center">{{ $invoice->invoiceItems->sum('quantity') }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
