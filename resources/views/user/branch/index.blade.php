...
@section('content')
            ...
            <div class="card-header">
                <div class="text-end">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a data-bs-toggle="modal" id="branchBtn" data-bs-target="#branchModal" href="javascript:;" class="btn btn-success"><i class="fas fa-plus"></i> {{ __('messages.branch') }}</a>
                    </div>
                </div>
            </div>
    ...
    @include('user.branch.branch-creation-modal')
@endsection
        ...
        function destroy(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var data_id = id;
                    var url = '{{ route('user.branch.destroy', ':id') }}';
