...
@section('content')
    <div class="main-content-body">
        <div class="card">
            <div class="card-body">
                <div class=" mg-t-5" id="">
                    <p class="display-6 text-center">{{ __('Create New Buy Return') }}</p>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                        <div class="d-flex">
                                            <span class="input-group-text"id="basic-addon1"><i class="fas fa-balance-scale" title="Supplier"></i></span>
                                    ...
                                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                        <div class="d-flex">
                                            <span class="input-group-text"id="basic-addon1"><i class="fas fa-balance-scale" title="Invoice"></i></span>
                                            <div class="input-group">
                                    ...
                                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-text" title="Name"><i class="fas fa-image" title="Name"></i></span>
                                    ...
                                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                        <div class="d-flex">
                                            <span class="input-group-text"id="basic-addon1"><i class="fas fa-balance-scale" title="Unit"></i></span>
                                            <div class="input-group">
                                    ...
                                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-text"id="basic-addon1"><i class="fas fa-box" title="carton"></i></span>
                                            <input type="text" class="form-control" name="carton" placeholder="Carton">
                                        </div>
                                    </div>
                                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                        <div class="d-flex">
                                            <span class="input-group-text"id="basic-addon1"><i class="fas fa-layer-group" title="Group"></i></span>
                                            <div class="input-group">
                                    ...
                                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="StockWarningQuantity" placeholder="Stock Warning Quantity">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 mt-3 d-flex justify-content-center">
                                    ...
                                    <button type="submit" class="add-to-cart btn btn-primary">Add New Product</button>
                                </div>
                            </div>
                        </div>
                    </form>
