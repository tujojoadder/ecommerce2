            ...
            <div class="card-header">
                <div class="text-end">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a data-bs-toggle="modal" id="productBtn" data-bs-target="#assetProductModal" href="javascript:;" class="btn btn-success"><i class="fas fa-plus"></i> {{ __('messages.add') }}</a>
                    </div>
                </div>
            </div>
        ...
        function destroy(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var data_id = id;
                    var url = '{{ route('user.product-asset.destroy', ':id') }}';
