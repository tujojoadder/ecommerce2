...
@push('scripts')
    ...
    <script>
        $(function() {
            ...
            $("#category_id, #starting_date, #ending_date").on("change", function() {
            ...
            dataTable = $('#file-export-datatable').DataTable({
                ...
                initComplete: function(settings, json) {
                    ...
                    function updateFooterTotals() {
                        ...
                        var tfootContent = '<tfoot class="text-center font-weight-bold"><tr><td colspan="6">Total</td><td>' + initialTotal + '</td><td>' + balanceTotal + '</td><td colspan="2">{{ __('messages.total') }}: ' + (balanceTotal + initialTotal) + '</td></tr></tfoot>';
