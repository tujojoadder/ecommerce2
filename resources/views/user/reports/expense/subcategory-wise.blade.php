...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#client_id, #expense_subcategory_id, #expense_category_id, #supplier_id, #starting_date, #ending_date").on("change", function() {
            ...
            dataTable = $('#file-export-datatable').DataTable({
                ...
                ajax: {
                    ...
                    data: function(d) {
                        ...
                        d.subcategory_id = $("#expense_subcategory_id").val();
