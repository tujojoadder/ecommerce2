            ...
            <div class="card-header">
                <div class="text-end">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a data-bs-toggle="modal" id="bankBtn" data-bs-target="#bankModal" href="javascript:;" class="btn btn-success"><i class="fas fa-plus"></i> {{ __('messages.bank') }}</a>
                    </div>
                </div>
            </div>
        ...
        function destroy(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var data_id = id;
                    var url = '{{ route('user.configuration.bank.destroy', ':id') }}';
