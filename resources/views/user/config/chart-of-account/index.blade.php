                        ...
                        <div class="card-body bg-white table-responsive">
                            <div class="text-end">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <a data-bs-toggle="modal" id="chartOfAccountBtn" data-bs-target="#chartOfAccountModal" href="javascript:;" class="btn btn-success"><i class="fas fa-plus"></i> {{ __('messages.chart_of_account') }}</a>
                                </div>
                            </div>
                            {!! $dataTable->table() !!}
                        </div>
...
@push('scripts')
    ...
    <script>
        function destroy(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var data_id = id;
                    var url = '{{ route('user.configuration.chart-of-account.destroy', ':id') }}';
        ...
        $("#chartOfAccountBtn").on('click', function() {
