        ...
        <div class="card">
            <div class="card-body">
                <div class="collapse mg-t-5" id="addReceiveCollapse">
                    <p class="display-6 text-center">{{ __('Payment Method') }}</p>
                                ...
                                <div class="row">
                                    <div class="form-group col-xl-6 col-lg-6 col-md-6 d-flex align-items-center">
                                        <div class="input-group">
                                            <span class="input-group-text" title="paymentMethod" id="basic-addon1"><i class="fas fa-pencil-alt" title="paymentMethod"></i></span>
                                    ...
                                    <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 mt-3 d-flex justify-content-center">
                                        ...
                                        <button type="submit" class="add-to-cart btn btn-primary">Add Payment Method</button>
                                    </div>
                                </div>
                            </div>
                        </div>
