...
@section('content')
    <div class="main-content-body">
        <div class="card">
            <div class="card-body">
                <div class=" mg-t-5" id="">
                    <p class="display-6 text-center">{{ __('messages.create') }} {{ __('messages.batch') }} {{ __('messages.product') }}</p>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-text"id="basic-addon1"><i class="fas fa-bars" title="{{ __('messages.finish') }}"></i></span>
                                            <input type="text" class="form-control" name="FinishJob" placeholder="{{ __('messages.finish') }}">
                                        </div>
                                    </div>
                                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                        <div class="d-flex">
                                            <span class="input-group-text"id="basic-addon1"><i class="fas fa-university" title="{{ __('messages.damage') }}"></i></span>
                                            <div class="input-group">
                                                <select name="DamagedRawMetarial" class="form-control select2">
                                                    <option value="1">{{ __('messages.damage') }}</option>
                                                </select>
                                            </div>
                                            <a data-bs-target="#accountModal" data-bs-toggle="modal" class="add-to-cart btn btn-danger" type="button" href="javascript:;"><i class="fas fa-plus"></i></a>
                                        </div>
                                    ...
                                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                        <div class="d-flex">
                                            <span class="input-group-text"id="basic-addon1"><i class="fas fa-university" title="{{ __('messages.market') }} {{ __('messages.receive') }} {{ __('messages.metarial') }}"></i></span>
                                            <div class="input-group">
                                                <select name="RawMetarial" class="form-control select2">
                                                    <option value="1">{{ __('messages.market') }} {{ __('messages.receive') }} {{ __('messages.metarial') }}</option>
                                                </select>
                                            </div>
                                            <a data-bs-target="#accountModal" data-bs-toggle="modal" class="add-to-cart btn btn-danger" type="button" href="javascript:;"><i class="fas fa-plus"></i></a>
                                        </div>
                                    ...
                                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-text"id="basic-addon1"><i class="fas fa-bars" title="{{ __('messages.batch') }} {{ __('messages.number') }}"></i></span>
                                            <input type="text" class="form-control" name="BatchNumber" placeholder="{{ __('messages.batch') }} {{ __('messages.number') }}">
                                        </div>
                                    </div>
                                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                        <div class="d-flex">
                                            <span class="input-group-text"id="basic-addon1"><i class="fas fa-university" title="{{ __('messages.group') }}"></i></span>
                                            <div class="input-group">
                                                <select name="RawMetarial" class="form-control select2">
