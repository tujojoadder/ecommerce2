            ...
            <div class="card-header">
                <div class="text-end">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="javascript::void(0)" data-bs-toggle="modal" id="clientGroupBtn" data-bs-target="#brandModal" class="btn btn-success">
                                <i class="fas fa-plus d-inline"></i> {{ __('messages.add') }} {{ __('messages.brand') }}
                            </a>
                        </div>
                    </div>
                </div>
        ...
        function destroy(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var data_id = id;
                    var url = '{{ route('user.brand.destroy', ':id') }}';
