            ...
            <div class="card px-0">
                <div class="card-header border-bottom d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <a href="{{ route('user.supplier.create') }}" class="btn btn-success me-2"><i class="fas fa-plus d-inline"></i> {{ __('messages.add_new') }}</a>
                        <div class="d-flex">
                ...
                <div class="card-body bg-white table-responsive">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-3 mb-1" id="suppliers">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="animated-label active-label" for="supplier_id">{{ __('messages.search') . ' ' . __('messages.all') }}</label>
                                    </div>
                                </div>
                                <div class="col-md-3 mb-1" id="suppliers_group">
                                    <label for="supplier_id">{{ __('messages.search_by_supplier') }} {{ __('messages.group') }}</label>
                    ...
                    <table class="table table-bordered table-hover file-export-datatable">
                        <thead>
                            <tr>
...
@push('scripts')
    ...
    <script>
        ...
        function updateRemainingDueDate() {
            ...
            var supplier_id = $("#supplier_id_for_due").val();
