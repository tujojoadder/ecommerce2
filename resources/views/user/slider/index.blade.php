...
@section('content')
            ...
            <div class="card-header">
                <div class="text-end">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="javascript::void(0)" data-bs-toggle="modal" id="clientGroupBtn" data-bs-target="#sliderModal" class="btn btn-success">
    ...
    @include('user.slider.slider-modal')
@endsection
        ...
        function destroy(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var data_id = id;
                    var url = '{{ route('user.slider.destroy', ':id') }}';
