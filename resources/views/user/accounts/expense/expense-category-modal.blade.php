        ...
        <div class="modal-content modal-content-demo shadow-lg">
            ...
            <div class="modal-body">
                    ...
                    <div class="row" id="expense-subcategory-form">
                        <div class="col-xl-12 col-lg-12 col-md-12">
                            <div class="form-group">
                                ...
                                <label for="name" class="animated-label"><i class="fas fa-layer-group"></i> {{ __('messages.expense') }} {{ __('messages.category') }}</label>
                            </div>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-info d-none" type="button" id="updateExpenseCategory" onclick="updateExpenseCategory();"><i class="fas fa-plus"></i> {{ __('messages.update') }}</button>
...
@push('scripts')
    ...
    <script>
        ...
        function addExpenseCategory() {
            var expense_category = $('#expense-subcategory-form #name').val();
            ...
            $.ajax({
                ...
                success: function(group) {
                    ...
                    setTimeout(() => {
                        getExpenseCategoryInfo('/get-expense-category', group.id);
                    }, 1000);
                },
