            ...
            <div class="card-header">
                <div class="text-end">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{ route('user.client.index') }}" class="btn btn-secondary">
                                <i class="fas fa-list d-inline"></i> {{ __('messages.client') }} {{ __('messages.list') }}
                            </a>
                            <a data-bs-toggle="modal" id="clientGroupBtn" data-bs-target="#clientGroupModal" href="javascript:;" class="btn btn-success"><i class="fas fa-plus d-inline"></i> {{ __('messages.group') }} {{ __('messages.add') }}</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        function destroy(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var data_id = id;
                    var url = '{{ route('user.client-group.destroy', ':id') }}';
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            Swal.fire({
                                ...
                                position: 'top-end',
                                icon: 'error',
                                title: 'Client Group deleted successfully!',
