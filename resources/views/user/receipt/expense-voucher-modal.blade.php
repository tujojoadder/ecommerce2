<div id="moneyReceiptBody">
    <div class="card " style="border: 2px solid #0fb465; margin-bottom: 0px; font-family: 'Bree Serif', serif;">
        <div class="card-header" style="background: #0fb46508!important; border-bottom: 2px solid #0fb465; padding-bottom: 2px;">
            <div class="row">
                    ...
                    <table class="table-bordered w-100 receipt-info">
                        <tr>
                            <td class="receipt-no" style="padding: 10px !important; font-size: 12px; font-weight: 600; letter-spacing: 1px; font-family: sans-serif; border: 1px solid #0fb465; background: #0fb465; color: #fff;">
                                Voucher No : #{{ zero($transaction->id) . $transaction->id }}
                            </td>
                        </tr>
                        <tr>
                ...
                <div class="col-12" style="text-align: center;">
                    <h2 style="font-size: 24px; margin: 0; text-align: center; font-weight: 700; color: #0fb465; letter-spacing: 1.5px; text-transform: uppercase; font-family: sans-serif; margin-top: 11px;">Expense Voucher</h2>
                </div>
            </div>
        </div>
        <div class="card-body" style="background: #0fb46508!important;">
            <div class="client-info">
                <h2 style="margin-bottom: 10px; font-size: 18px; font-family: 'Stoke', serif; border-bottom: 1px dashed #0fb465; padding-bottom: 5px;">
                    <strong>Payment To :</strong> {{ $receiver_name ?? 'N/A' }}
                </h2>
                ...
                <h2 style="margin-bottom: 10px; font-size: 18px; font-family: 'Stoke', serif; border-bottom: 1px dashed #0fb465; padding-bottom: 5px;"><strong>Category :</strong> {{ $transaction->expenseCategory->name ?? '' }}
                    @php
                ...
                <h2 style="margin-bottom: 10px; padding-top: 10px; margin-top: 10px; font-size: 18px; font-family: 'Stoke', serif; padding-bottom: 5px;"><strong>BDT :</strong> <span style="border: 1px solid #0fb465; padding: 5px 50px; font-size: 17px; font-weight: 600; padding-left: 10px">{{ en2bn($transaction->amount) ?? '0.00' }}</span></h2>
            </div>
            <div class="client-info" style="margin-top: 70px;">
                <div class="row">
                    <div class="col-4 px-0" style="text-align: center;">
                        <h5 style="width: 70%; padding-top: 10px; border-top: 1px solid #0fb465; margin: auto;">Receiver's</h5>
                    </div>
                    <div class="col-4 px-0" style="text-align: center;">
                        <h5 style="width: 70%; padding-top: 10px; border-top: 1px solid #0fb465; margin: auto;">Accounts</h5>
                    </div>
                    <div class="col-4 px-0" style="text-align: center;">
                        <h5 style="width: 70%; padding-top: 10px; border-top: 1px solid #0fb465; margin: auto;">Authorized</h5>
                    </div>
                </div>
            </div>
        </div>
