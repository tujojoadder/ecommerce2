        ...
        <div class="card">
            <div class="card-body">
                <div class="collapse mg-t-5" id="addReceiveCollapse">
                    <p class="display-6 text-center">{{ __('messages.metarial') }} {{ __('messages.group') }} {{ __('messages.create') }}</p>
                    <form action="{{ route('user.account.store') }}" method="post">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-xl-6 col-lg-6 col-md-6 d-flex">
                                        <div class="input-group">
                                            <span class="input-group-text" title="{{ __('messages.group') }}" id="basic-addon1"><i class="fas fa-file-invoice" title="GroupName"></i></span>
                                            <input type="text" class="form-control" name="GroupName" placeholder="{{ __('messages.group') }} {{ __('messages.name') }}">
                                        </div>
                                    </div>
                        ...
                        <div class="card-body bg-white table-responsive">
                            <div class="text-end">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <a aria-controls="addReceiveCollapse" aria-expanded="false" class="btn ripple btn-success mb-2" data-bs-toggle="collapse" href="#addReceiveCollapse" role="button"><i class="fas fa-plus text-white"></i> {{ __('messages.group') }}</a>
                                </div>
                            </div>
                            {!! $dataTable->table() !!}
                        </div>
