...
@section('content')
                        ...
                        <div class="card-body bg-white table-responsive">
                            <div class="text-end">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <div>
                                        <a id="softwareManagementModal" href="javascript:;" class="btn btn-success languageModal"><i class="fas fa-plus d-inline"></i> {{ __('messages.update') }} {{ __('messages.status') }}</a>
                                    </div>
                                </div>
                            </div>
                            {!! $dataTable->table() !!}
    ...
    @include('admin.management.management-modal')
@endsection
...
@push('scripts')
    ...
    <script>
        ...
        $("#softwareManagementModal").on('click', function() {
