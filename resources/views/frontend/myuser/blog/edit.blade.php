                        ...
                        <form action="{{ route('frontend.blog.update', $blog->id) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror"
                                    rows="10" required>{{ old('description', $blog->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="tags" id="tagsInput"
                                    ...
                                    value='@json($blog->tags)' placeholder="Enter tags">
                            ...
                            <div class="form-group">
                                ...
                                @if ($blog->image)
                                    <div class="mt-2">
                                        <img src="{{ asset('storage/blog/' . $blog->image) }}" alt="Current Blog Image"
